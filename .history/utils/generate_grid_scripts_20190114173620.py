...
renyiQs = [1.5, 2.0, 2.5]
num_of_trains = [ 4]  # for Ant & HalfCheetah
...
def generate_script(algorithm, scale_reward, tasllisQ = 2.0, renyiQ = 2.0, num_of_train=4):
    ...
    for problem in problems:
        ...
        if algorithm == "RAC":
            ...
            script_name = directory + "/" + algorithm + "_" + problem + "_sr_" + str(scale_reward) + "_nbt_" + str(
                num_of_train) + "_nbt_" + str(num_of_train) + ".sh"
            f1 = open(script_name, 'w')
