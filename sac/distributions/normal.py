...
class Normal(object):
    def __init__(
        ...
        print('from normal ' + str(self._layer_sizes))
    ...
    def _create_graph(self):
        ...
        # CG: for information on the strided_slice operation, see https://www.tensorflow.org/api_docs/python/tf/strided_slice
        self._mu_t = mu_and_logsig_t[..., :Dx]   # CG: first part of the NN output represents mu.
        self._log_sig_t = tf.clip_by_value(mu_and_logsig_t[..., Dx:], LOG_SIG_CAP_MIN, LOG_SIG_CAP_MAX)   # CG: second part of the NN output represents log(sigma).
