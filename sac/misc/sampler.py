...
class Sampler(object):
    ...
    def random_batch_with_index(self, index):
        return self.pool.random_batch_with_index(self._batch_size, index)
...
class SimpleSampler(Sampler):
    ...
    def sample(self):
        ...
        if terminal or self._path_length >= self._max_path_length:
            ...
            # CG: return true to indicate the end of an episode.
            return True

        else:
            self._current_observation = next_observation

            # CG: return false to indicate that the end of an episode has not been reached yet.
            return False
